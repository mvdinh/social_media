        ...
        >
            ...
            <div className="flex-grow min-w-0 ml-3">
                <div className="flex items-center justify-between">
                    <p
                        className={`font-semibold truncate ${isUnread ? "text-gray-900" : "text-gray-800"
                            }`}
                    >
                        {user.full_name}
                    </p>
                    <span
                        className={`text-xs ml-2 ${isUnread ? "text-indigo-600 font-semibold" : "text-gray-500"
                            }`}
                    >
                        {displayTime}
                    </span>
                ...
                <div className="flex items-center justify-between mt-0.5">
                    <p
                        className={`text-sm truncate ${isUnread ? "text-indigo-700 font-medium" : "text-gray-600"
                            }`}
                    >
                ...
                <div className="flex space-x-2 overflow-x-auto whitespace-nowrap">
                    {tabs.map((tab) => (
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-full text-sm font-semibold transition-colors duration-200 ${activeTab === tab
